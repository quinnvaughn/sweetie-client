...
export default function PrivacyPolicy() {
	return (
		...
		>
			...
			<h2 className={css({ textStyle: "h1", fontSize: 32 })}>
				Interpretation and Definitions
			</h2>
			<h3 className={css({ textStyle: "h1", fontSize: 28 })}>Interpretation</h3>
			<p className={css({ textStyle: "paragraph" })}>
			...
			<h3 className={css({ textStyle: "h1", fontSize: 28 })}>Definitions</h3>
			<p className={css({ textStyle: "paragraph" })}>
				For the purposes of this Privacy Policy:
			</p>
			<ul className={css({ listStyle: "inside" })}>
				<li>
					<p className={css({ textStyle: "paragraph", display: "inline" })}>
				...
				<li>
					<p className={css({ textStyle: "paragraph", display: "inline" })}>
						...
						this Agreement) refers to Blush Experiences, Ltd., 1670 Manning Ave,
				...
				<li>
					<p className={css({ textStyle: "paragraph", display: "inline" })}>
						<strong>Website</strong> refers to Sweetie, accessible from{" "}
						<a
							href="https://trysweetie.com"
			...
			<h3 className={css({ textStyle: "h1", fontSize: 28 })}>
				Types of Data Collected
			</h3>
			<h4 className={css({ textStyle: "h1", fontSize: 24 })}>Personal Data</h4>
			<p className={css({ textStyle: "paragraph" })}>
			...
			<h4 className={css({ textStyle: "h1", fontSize: 24 })}>Usage Data</h4>
			<p className={css({ textStyle: "paragraph" })}>
			...
			<h4 className={css({ textStyle: "h1", fontSize: 24 })}>
			...
			<ul className={css({ listStyle: "inside" })}>
				<li>
					...
					<p className={css({ textStyle: "paragraph" })}>Administered by: Us</p>
					<p className={css({ textStyle: "paragraph" })}>
			...
			<h2 className={css({ textStyle: "h1", fontSize: 32 })}>Contact Us</h2>
			<p className={css({ textStyle: "paragraph" })}>
				If you have any questions about this Privacy Policy, You can contact us:
			</p>
			<ul className={css({ listStyle: "inside" })}>
				<li>By email: quinn@trysweetie.com</li>
			</ul>
		</PageContainer>
	)
}
