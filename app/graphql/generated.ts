...
export type GroupDateCardFragment = { __typename: 'GroupDate', title: string, image: string, description: string, id: string, startDate: string, lastSignupDate: string, tastemaker: { __typename: 'Tastemaker', id: string, isSetup: boolean, formattedPrice: string, user: { __typename: 'User', id: string, username: string, name: string, profile?: { __typename: 'UserProfile', id: string, avatar?: string | null } | null } }, cities: Array<{ __typename: 'City', id: string, nameAndState: string }> };
