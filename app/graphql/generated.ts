...
export type GetFreeDateQuery = { __typename: 'Query', freeDate: { __typename: 'Error', message: string } | { __typename: 'FreeDate', id: string, title: string, description: string, thumbnail: string, retired: boolean, nsfw: boolean, createdAt: string, updatedAt: string, isUserTastemaker: boolean, viewerFavorited: boolean, cities: Array<{ __typename: 'City', id: string, nameAndState: string, name: string }>, tags: Array<{ __typename: 'Tag', id: string, name: string }>, timesOfDay: Array<{ __typename: 'TimeOfDay', id: string, name: string }>, tastemaker: { __typename: 'Tastemaker', id: string, isSetup: boolean, formattedPrice: string, user: { __typename: 'User', id: string, username: string, name: string, profile?: { __typename: 'UserProfile', id: string, avatar?: string | null } | null } }, stops: Array<{ __typename: 'DateStop', id: string, title: string, order: number, content: string, travel?: { __typename: 'Travel', distance: number, duration: number, mode: TravelMode } | null, location: { __typename: 'Location', id: string, name: string, website?: string | null, address: { __typename: 'Address', id: string, formattedAddress: string, coordinates: { __typename: 'Coordinates', lat: number, lng: number } } } }>, exploreMore: Array<{ __typename: 'FreeDate', id: string, title: string, retired: boolean, thumbnail: string, updatedAt: string, nsfw: boolean, description: string, viewerFavorited: boolean, tastemaker: { __typename: 'Tastemaker', id: string, user: { __typename: 'User', id: string, name: string, profile?: { __typename: 'UserProfile', id: string, avatar?: string | null } | null } }, cities: Array<{ __typename: 'City', id: string, nameAndState: string }> }> } };
