...
export type UpdateFreeDateMutation = { __typename: 'Mutation', updateFreeDate: { __typename: 'AuthError', message: string } | { __typename: 'Error', message: string } | { __typename: 'FieldErrors', fieldErrors: Array<{ __typename: 'FieldError', field: string, message: string }> } | { __typename: 'FreeDate', id: string, title: string, description: string, thumbnail: string, archived: boolean, nsfw: boolean, tags: Array<{ __typename: 'Tag', id: string, name: string }>, tastemaker: { __typename: 'Tastemaker', id: string, isSetup: boolean, formattedPrice: string, user: { __typename: 'User', id: string, username: string, name: string, profile?: { __typename: 'UserProfile', id: string, avatar?: string | null } | null } }, stops: Array<{ __typename: 'DateStop', id: string, title: string, order: number, content: string, estimatedTime: number, formattedEstimatedTime: string, travel?: { __typename: 'Travel', distance: number, duration: number, mode: TravelMode } | null, location: { __typename: 'Location', id: string, name: string, website?: string | null, address: { __typename: 'Address', id: string, formattedAddress: string, city: { __typename: 'City', id: string, name: string }, coordinates: { __typename: 'Coordinates', lat: number, lng: number } } } }> } };
...
export type GetFreeDateQuery = { __typename: 'Query', freeDate: { __typename: 'Error', message: string } | { __typename: 'FreeDate', id: string, title: string, description: string, thumbnail: string, archived: boolean, nsfw: boolean, createdAt: string, updatedAt: string, isUserTastemaker: boolean, viewerFavorited: boolean, viewerAuthorizedGoogleCalendar: boolean, recommendedTime: string, cities: Array<{ __typename: 'City', id: string, nameAndState: string, name: string }>, tags: Array<{ __typename: 'Tag', id: string, name: string }>, tastemaker: { __typename: 'Tastemaker', id: string, isSetup: boolean, formattedPrice: string, user: { __typename: 'User', id: string, username: string, name: string, profile?: { __typename: 'UserProfile', id: string, avatar?: string | null } | null } }, stops: Array<{ __typename: 'DateStop', id: string, title: string, order: number, content: string, estimatedTime: number, formattedEstimatedTime: string, travel?: { __typename: 'Travel', distance: number, duration: number, mode: TravelMode } | null, location: { __typename: 'Location', id: string, name: string, website?: string | null, address: { __typename: 'Address', id: string, formattedAddress: string, city: { __typename: 'City', id: string, name: string }, coordinates: { __typename: 'Coordinates', lat: number, lng: number } } } }>, exploreMore: Array<{ __typename: 'FreeDate', id: string, title: string, archived: boolean, thumbnail: string, updatedAt: string, nsfw: boolean, description: string, viewerFavorited: boolean, estimatedTime: string, tastemaker: { __typename: 'Tastemaker', id: string, user: { __typename: 'User', id: string, name: string, profile?: { __typename: 'UserProfile', id: string, avatar?: string | null } | null } }, cities: Array<{ __typename: 'City', id: string, nameAndState: string }> }> } };
...
export type PlannedDateListQuery = { __typename: 'Query', viewer?: { __typename: 'User', upcomingPlannedDates: Array<{ __typename: 'PlannedDate', id: string, plannedTime: string, freeDate: { __typename: 'FreeDate', id: string, title: string, archived: boolean, thumbnail: string, updatedAt: string, nsfw: boolean, description: string, viewerFavorited: boolean, estimatedTime: string, tastemaker: { __typename: 'Tastemaker', id: string, user: { __typename: 'User', id: string, name: string, profile?: { __typename: 'UserProfile', id: string, avatar?: string | null } | null } }, cities: Array<{ __typename: 'City', id: string, nameAndState: string }> }, guest?: { __typename: 'PlannedDateGuest', name?: string | null } | null }>, previousPlannedDates: Array<{ __typename: 'PlannedDate', id: string, plannedTime: string, freeDate: { __typename: 'FreeDate', id: string, title: string, archived: boolean, thumbnail: string, updatedAt: string, nsfw: boolean, description: string, viewerFavorited: boolean, estimatedTime: string, tastemaker: { __typename: 'Tastemaker', id: string, user: { __typename: 'User', id: string, name: string, profile?: { __typename: 'UserProfile', id: string, avatar?: string | null } | null } }, cities: Array<{ __typename: 'City', id: string, nameAndState: string }> }, guest?: { __typename: 'PlannedDateGuest', name?: string | null } | null }> } | null };
