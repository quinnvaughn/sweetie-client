...
export type CreateDateItineraryInput = {
  ...
  selectedStopIds: Array<Scalars['String']['input']>;
...
export type DateStopOption = {
  ...
  content: Scalars['String']['output'];
  hasNextStop: Scalars['Boolean']['output'];
  hasPreviousStop: Scalars['Boolean']['output'];
  id: Scalars['ID']['output'];
  location: Location;
...
export type CreateDateItineraryMutation = { __typename: 'Mutation', createDateItinerary: { __typename: 'AuthError', message: string } | { __typename: 'Error', message: string } | { __typename: 'FieldErrors', fieldErrors: Array<{ __typename: 'FieldError', message: string, field: string }> } | { __typename: 'PlannedDate', plannedTime: string, variation?: { __typename: 'FreeDateVariation', freeDate: { __typename: 'FreeDate', title: string, tastemaker: { __typename: 'Tastemaker', user: { __typename: 'User', id: string, name: string, username: string } }, stops: Array<{ __typename: 'DateStop', location: { __typename: 'Location', name: string } }>, cities: Array<{ __typename: 'City', name: string }> } } | null } };
