...
export type AcceptCustomDateSuggestionPayload =
	| AuthError
...
export type CreateDateItineraryPayload =
	| AuthError
	| Error
	| FieldErrors
	| PlannedDate
...
export type CreateTastemakerProfilePayload =
	| AuthError
	| Error
	| FieldErrors
	| Tastemaker
...
export type GetAcceptedCustomDatesPayload =
	| AuthError
	| Error
	| GetAcceptedCustomDatesResult
...
export type GetPendingCustomDatesPayload =
	| AuthError
	| Error
	| GetPendingCustomDatesResult
...
export type MakeChangesOnSuggestionPayload =
	| AuthError
	| CustomDateSuggestion
	| Error
	| FieldErrors
...
export type Query = {
	...
	featuredFreeDates: Array<FreeDate>
...
export type RequestChangesOnCustomDateSuggestionPayload =
	| AuthError
	| CustomDateSuggestion
	| Error
	| FieldErrors
...
export type RequestCustomDatePayload =
	| AuthError
	| CustomDate
	| Error
	| FieldErrors
...
export type RequestRefundOnCustomDatePayload =
	| AuthError
	| CustomDateRefund
	| Error
...
export type RespondToRequestedRefundPayload =
	| AuthError
	| CustomDateRefund
	| Error
...
export type SaveFreeDateDraftPayload =
	| AuthError
	| Error
	| FieldErrors
	| FreeDateDraft
...
export type SendCustomDateMessagePayload =
	| AuthError
	| CustomDateMessage
	| Error
	| FieldErrors
...
export type DateStopItemFragment = {
	__typename: "DateStop"
	id: string
	title: string
	order: number
...
export type FreeDateCardFragment = {
	__typename: "FreeDate"
	id: string
	title: string
	retired: boolean
	...
	cities: Array<{ __typename: "City"; id: string; nameAndState: string }>
}

export type GetFreeDateFragment = {
	__typename: "FreeDate"
	id: string
	title: string
	description: string
	...
	createdAt: string
	updatedAt: string
	isUserTastemaker: boolean
	viewerFavorited: boolean
	viewerAuthorizedGoogleCalendar: boolean
	cities: Array<{
		__typename: "City"
		id: string
		nameAndState: string
	...
	timesOfDay: Array<{ __typename: "TimeOfDay"; id: string; name: string }>
	tastemaker: {
		__typename: "Tastemaker"
		id: string
		isSetup: boolean
...
export type PlannedDateCardFragment = {
	...
	guest?: { __typename: "PlannedDateGuest"; name?: string | null } | null
}

export type TagsFragment = { __typename: "Tag"; id: string; name: string }

export type DateAnalyticsCardFragment = {
	__typename: "FreeDate"
	id: string
	title: string
	thumbnail: string
	numPlannedDates: number
	favoriteCount: number
	views?: { __typename: "FreeDateViews"; id: string; viewCount: number } | null
}

export type DateSuggestionCardFragment = {
	__typename: "DateSuggestion"
	id: string
	text: string
	cities: Array<{ __typename: "City"; id: string; nameAndState: string }>
...
export type TastemakerInfoFragment = {
	__typename: "Tastemaker"
	id: string
	isSetup: boolean
	formattedPrice: string
...
export type UserProfileHeadingFragment = {
	__typename: "User"
	id: string
...
export type UserProfileLeftSideFragment = {
	__typename: "User"
	id: string
	isUsersProfile: boolean
	name: string
...
export type LoginMutation = {
	__typename: "Mutation"
	login:
		| { __typename: "AlreadyLoggedInError"; message: string }
		| { __typename: "Error" }
		| {
				__typename: "FieldErrors"
				fieldErrors: Array<{
...
export type LogoutMutation = {
	...
	logout:
		...
		| { __typename: "Error"; message: string }
		| { __typename: "LogoutResult"; data: boolean }
}
...
export type RequestPasswordResetMutation = {
	...
	requestPasswordReset:
		...
		| { __typename: "RequestPasswordResetResponse"; email: string }
}
...
export type CreateDateItineraryMutation = {
	__typename: "Mutation"
	createDateItinerary:
		| { __typename: "AuthError"; message: string }
		| { __typename: "Error"; message: string }
...
export type SaveFreeDateDraftMutation = {
	__typename: "Mutation"
	saveFreeDateDraft:
		| { __typename: "AuthError"; message: string }
		| { __typename: "Error"; message: string }
...
export type ToggleFavoriteMutation = {
	...
	toggleFavorite:
		| { __typename: "AuthError"; message: string }
		| { __typename: "Error"; message: string }
		| { __typename: "ToggleFavoriteResult"; type: string }
}
...
export type CreateFreeDateMutation = {
	__typename: "Mutation"
	createFreeDate:
		| { __typename: "AuthError"; message: string }
		| { __typename: "Error"; message: string }
...
export type RetireFreeDateMutation = {
	__typename: "Mutation"
	retireFreeDate:
		| { __typename: "AuthError"; message: string }
		| { __typename: "Error"; message: string }
...
export type UnretireFreeDateMutation = {
	__typename: "Mutation"
	unretireFreeDate:
		| { __typename: "AuthError" }
		| { __typename: "Error"; message: string }
...
export type DeleteImageMutation = {
	...
	deleteImage:
		| { __typename: "AuthError"; message: string }
		| { __typename: "DeleteImageResult"; data: boolean }
		| { __typename: "Error" }
}
...
export type GeneratePresignedUrlMutation = {
	...
	generatePresignedUrl:
		| { __typename: "AuthError"; message: string }
		| { __typename: "Error"; message: string }
		| { __typename: "GeneratePresignedUrlResult"; data: string }
}
...
export type CreateLocationMutation = {
	...
	createLocation:
		...
		| {
				...
				id: string
				name: string
				address: { __typename: "Address"; id: string; formattedAddress: string }
		  }
}
...
export type DeleteFreeDateDraftMutation = {
	__typename: "Mutation"
	deleteFreeDateDraft:
		| { __typename: "AuthError"; message: string }
		| { __typename: "Error"; message: string }
...
export type ViewerIsLoggedInQuery = {
	__typename: "Query"
	viewer?: {
		__typename: "User"
		id: string
...
export type GetCitiesQuery = {
	...
	cities: {
		...
		edges: Array<{
			__typename: "CityEdge"
			cursor: string
			node: { __typename: "City"; nameAndState: string; id: string }
		}>
		pageInfo: {
			__typename: "PageInfo"
			hasNextPage: boolean
...
export type GetFreeDateDraftQuery = {
	__typename: "Query"
	freeDateDraft:
		| { __typename: "AuthError"; message: string }
		| { __typename: "Error"; message: string }
...
export type GetViewerFavoritesQuery = {
	__typename: "Query"
	viewer?: {
		__typename: "User"
		favoritedDates: Array<{
			__typename: "FreeDate"
			id: string
			title: string
			retired: boolean
...
export type GetEditFreeDateQuery = {
	__typename: "Query"
	getEditFreeDate:
		| { __typename: "AuthError"; message: string }
		| { __typename: "Error"; message: string }
...
export type GetFeaturedDatesQuery = {
	__typename: "Query"
	featuredFreeDates: Array<{
		__typename: "FreeDate"
		id: string
		title: string
		retired: boolean
	...
	locations: {
		...
		edges: Array<{
			...
			node: {
				...
				id: string
				name: string
				address: { __typename: "Address"; formattedAddress: string; id: string }
			}
		}>
	}
}
...
export type PlannedDateListQuery = {
	__typename: "Query"
	viewer?: {
		__typename: "User"
		upcomingPlannedDates: Array<{
			__typename: "PlannedDate"
			id: string
			plannedTime: string
			freeDate: {
...
export type DateSuggestionsQuery = {
	__typename: "Query"
...
export type GetViewerFreeDateAnalyticsQueryVariables = Exact<{
	[key: string]: never
}>

export type GetViewerFreeDateAnalyticsQuery = {
	__typename: "Query"
	viewer?: {
		__typename: "User"
		id: string
...
export type GetViewerFreeDatesQuery = {
	__typename: "Query"
	viewer?: {
		__typename: "User"
		id: string
...
export type GetViewerInfoQuery = {
	__typename: "Query"
	viewer?: {
		__typename: "User"
		id: string
...
export type CustomDateSubscription = {
	__typename: "Subscription"
	customDate:
		| {
				__typename: "AcceptedCustomDateEvent"
				eventType: CustomDateType
				date: { __typename: "CustomDate"; id: string }
		  }
		| {
				__typename: "DeclinedCustomDateEvent"
				eventType: CustomDateType
...
} as unknown as DocumentNode<TagsFragment, unknown>
export const TastemakerInfoFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "TastemakerInfo" },
			typeCondition: {
				kind: "NamedType",
				name: { kind: "Name", value: "Tastemaker" },
			},
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{ kind: "Field", name: { kind: "Name", value: "id" } },
					{ kind: "Field", name: { kind: "Name", value: "isSetup" } },
					{ kind: "Field", name: { kind: "Name", value: "formattedPrice" } },
					{
						kind: "Field",
...
} as unknown as DocumentNode<TastemakerInfoFragment, unknown>
export const DateStopItemFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "DateStopItem" },
			typeCondition: {
				kind: "NamedType",
				name: { kind: "Name", value: "DateStop" },
			},
			selectionSet: {
				kind: "SelectionSet",
				selections: [
...
} as unknown as DocumentNode<DateStopItemFragment, unknown>
export const FreeDateCardFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "FreeDateCard" },
			typeCondition: {
				kind: "NamedType",
			...
			selectionSet: {
				...
				selections: [
					...
					{ kind: "Field", name: { kind: "Name", value: "viewerFavorited" } },
					{
						kind: "Field",
						name: { kind: "Name", value: "tastemaker" },
						selectionSet: {
					...
					},
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: "Field",
									name: { kind: "Name", value: "nameAndState" },
								},
							],
						},
					},
...
} as unknown as DocumentNode<FreeDateCardFragment, unknown>
export const GetFreeDateFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "GetFreeDate" },
			typeCondition: {
				kind: "NamedType",
				name: { kind: "Name", value: "FreeDate" },
			},
			selectionSet: {
				...
				selections: [
					...
					{ kind: "Field", name: { kind: "Name", value: "updatedAt" } },
					{ kind: "Field", name: { kind: "Name", value: "isUserTastemaker" } },
					{ kind: "Field", name: { kind: "Name", value: "viewerFavorited" } },
					{
						kind: "Field",
						name: { kind: "Name", value: "viewerAuthorizedGoogleCalendar" },
					},
					{
						kind: "Field",
						name: { kind: "Name", value: "cities" },
					...
					{
						kind: "Field",
						name: { kind: "Name", value: "timesOfDay" },
						selectionSet: {
							kind: "SelectionSet",
							selections: [
								{ kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<GetFreeDateFragment, unknown>
export const PlannedDateCardFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "PlannedDateCard" },
			typeCondition: {
				kind: "NamedType",
				name: { kind: "Name", value: "PlannedDate" },
			},
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					...
					{ kind: "Field", name: { kind: "Name", value: "id" } },
					{ kind: "Field", name: { kind: "Name", value: "plannedTime" } },
					{
						kind: "Field",
...
} as unknown as DocumentNode<PlannedDateCardFragment, unknown>
export const DateAnalyticsCardFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "DateAnalyticsCard" },
			typeCondition: {
				kind: "NamedType",
				name: { kind: "Name", value: "FreeDate" },
			},
			selectionSet: {
				...
				selections: [
					...
					{ kind: "Field", name: { kind: "Name", value: "title" } },
					{ kind: "Field", name: { kind: "Name", value: "thumbnail" } },
					{ kind: "Field", name: { kind: "Name", value: "numPlannedDates" } },
...
} as unknown as DocumentNode<DateAnalyticsCardFragment, unknown>
export const DateSuggestionCardFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "DateSuggestionCard" },
			typeCondition: {
				kind: "NamedType",
				name: { kind: "Name", value: "DateSuggestion" },
			},
			selectionSet: {
				kind: "SelectionSet",
				selections: [
...
} as unknown as DocumentNode<DateSuggestionCardFragment, unknown>
export const DraftCardFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "DraftCard" },
			typeCondition: {
				kind: "NamedType",
				name: { kind: "Name", value: "FreeDateDraft" },
			},
			selectionSet: {
				kind: "SelectionSet",
				selections: [
...
} as unknown as DocumentNode<DraftCardFragment, unknown>
export const UserProfileHeadingFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "UserProfileHeading" },
			typeCondition: {
				kind: "NamedType",
				name: { kind: "Name", value: "User" },
			},
			selectionSet: {
				...
				selections: [
					{ kind: "Field", name: { kind: "Name", value: "id" } },
					{ kind: "Field", name: { kind: "Name", value: "isUsersProfile" } },
					{ kind: "Field", name: { kind: "Name", value: "name" } },
					{ kind: "Field", name: { kind: "Name", value: "username" } },
					{
						kind: "Field",
...
} as unknown as DocumentNode<UserProfileHeadingFragment, unknown>
...
export const UserProfileLeftSideFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "UserProfileLeftSide" },
			typeCondition: {
				kind: "NamedType",
				name: { kind: "Name", value: "User" },
			},
...
} as unknown as DocumentNode<UserProfileLeftSideFragment, unknown>
					...
					},
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: "Field",
									name: { kind: "Name", value: "freeDates" },
									selectionSet: {
										kind: "SelectionSet",
										selections: [
											{ kind: "Field", name: { kind: "Name", value: "id" } },
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "LoginWithGoogleInput" },
						},
					},
				},
			],
						...
						selectionSet: {
							...
							selections: [
								{ kind: "Field", name: { kind: "Name", value: "__typename" } },
								{
									...
									typeCondition: {
										kind: "NamedType",
										name: { kind: "Name", value: "AlreadyLoggedInError" },
									},
									selectionSet: {
										kind: "SelectionSet",
										selections: [
						...
						selectionSet: {
							...
							selections: [
								...
								},
								{
									...
									typeCondition: {
										kind: "NamedType",
										name: { kind: "Name", value: "LogoutResult" },
									},
									selectionSet: {
										kind: "SelectionSet",
										selections: [
...
>
export const CreateDateItineraryDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "CreateDateItinerary" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "CreateDateItineraryInput" },
						},
					},
				},
			],
								...
								},
								{
									...
									selectionSet: {
										...
										selections: [
											{
												kind: "Field",
												name: { kind: "Name", value: "plannedTime" },
											},
											{
												kind: "Field",
												name: { kind: "Name", value: "freeDate" },
	...
	CreateDateItineraryMutation,
	CreateDateItineraryMutationVariables
>
export const SaveFreeDateDraftDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "SaveFreeDateDraft" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "SaveFreeDateDraftInput" },
						},
					},
				},
			],
	...
	SaveFreeDateDraftMutation,
	SaveFreeDateDraftMutationVariables
>
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "ToggleFavoriteInput" },
						},
					},
				},
			],
						...
						selectionSet: {
							...
							selections: [
								...
								},
								{
									...
									typeCondition: {
										kind: "NamedType",
										name: { kind: "Name", value: "ToggleFavoriteResult" },
									},
									selectionSet: {
										kind: "SelectionSet",
										selections: [
...
>
export const CreateFreeDateDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "CreateFreeDate" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "CreateFreeDateInput" },
						},
					},
				},
			],
...
export const RetireFreeDateDocument = {
	...
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "RetireFreeDate" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "RetireFreeDateInput" },
						},
					},
				},
			],
	...
	RetireFreeDateMutation,
	RetireFreeDateMutationVariables
>
export const UnretireFreeDateDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "UnretireFreeDate" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "UnretireFreeDateInput" },
						},
					},
				},
			],
	...
	UnretireFreeDateMutation,
	UnretireFreeDateMutationVariables
>
	...
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "UpdateFreeDate" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "UpdateFreeDateInput" },
						},
					},
				},
			],
						...
						selectionSet: {
							...
							selections: [
								...
								},
								{
									...
									typeCondition: {
										kind: "NamedType",
										name: { kind: "Name", value: "DeleteImageResult" },
									},
									selectionSet: {
										kind: "SelectionSet",
										selections: [
						...
						selectionSet: {
							...
							selections: [
								...
								},
								{
									...
									typeCondition: {
										kind: "NamedType",
										name: { kind: "Name", value: "GeneratePresignedUrlResult" },
									},
									selectionSet: {
										kind: "SelectionSet",
										selections: [
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "CreateLocationInput" },
						},
					},
				},
			],
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "TrackInput" },
						},
					},
				},
			],
...
} as unknown as DocumentNode<TrackMutation, TrackMutationVariables>
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "DeleteFreeDateDraftInput" },
						},
					},
				},
			],
...
>
export const ViewerIsLoggedInDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "ViewerIsLoggedIn" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
...
export const GetFreeDateDraftDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetFreeDateDraft" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
	...
	GetFreeDateDraftQuery,
	GetFreeDateDraftQueryVariables
>
export const GetViewerFavoritesDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetViewerFavorites" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
	...
	GetViewerFavoritesQuery,
	GetViewerFavoritesQueryVariables
>
export const GetEditFreeDateDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetEditFreeDate" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
	...
	GetEditFreeDateQuery,
	GetEditFreeDateQueryVariables
>
export const GetFeaturedDatesDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetFeaturedDates" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "featuredFreeDates" },
						selectionSet: {
							kind: "SelectionSet",
							selections: [
								{ kind: "Field", name: { kind: "Name", value: "id" } },
	...
	GetFeaturedDatesQuery,
	GetFeaturedDatesQueryVariables
>
...
} as unknown as DocumentNode<GetFreeDateQuery, GetFreeDateQueryVariables>
export const FreeDatesDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			...
			variableDefinitions: [
				...
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "nsfw" } },
					type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
				},
				{
					kind: "VariableDefinition",
...
} as unknown as DocumentNode<FreeDatesQuery, FreeDatesQueryVariables>
export const GetGoogleLocationsDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetGoogleLocations" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: { kind: "Variable", name: { kind: "Name", value: "text" } },
...
export const PlannedDateListDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "PlannedDateList" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								{
									kind: "Field",
									name: { kind: "Name", value: "upcomingPlannedDates" },
									selectionSet: {
										kind: "SelectionSet",
										selections: [
											{
								...
								{
									kind: "Field",
									name: { kind: "Name", value: "previousPlannedDates" },
									selectionSet: {
										kind: "SelectionSet",
										selections: [
											{
	...
	PlannedDateListQuery,
	PlannedDateListQueryVariables
>
export const DateSuggestionsDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "DateSuggestions" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
	...
	DateSuggestionsQuery,
	DateSuggestionsQueryVariables
>
...
} as unknown as DocumentNode<DraftsQuery, DraftsQueryVariables>
export const GetViewerFreeDateAnalyticsDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetViewerFreeDateAnalytics" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
	...
	GetViewerFreeDateAnalyticsQuery,
	GetViewerFreeDateAnalyticsQueryVariables
>
export const GetViewerFreeDatesDocument = {
	...
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetViewerFreeDates" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
	...
	GetViewerFreeDatesQuery,
	GetViewerFreeDatesQueryVariables
>
	...
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetViewerInfo" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
...
export const CustomDateDocument = {
	...
	definitions: [
		{
			...
			name: { kind: "Name", value: "CustomDate" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
	...
	CustomDateSubscription,
	CustomDateSubscriptionVariables
>
