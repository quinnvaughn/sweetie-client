...
export type DateStopOption = {
  ...
  id: Scalars['ID']['output'];
  location: Location;
  nextOptionId?: Maybe<Scalars['String']['output']>;
  optionOrder: Scalars['Int']['output'];
  previousOptionId?: Maybe<Scalars['String']['output']>;
...
export type GetFreeDateFragment = { __typename: 'FreeDate', id: string, title: string, description: string, thumbnail: string, archived: boolean, nsfw: boolean, createdAt: string, updatedAt: string, prep: Array<string>, isUserTastemaker: boolean, viewerFavorited: boolean, viewerAuthorizedGoogleCalendar: boolean, recommendedTime: string, cities: Array<{ __typename: 'City', id: string, nameAndState: string, name: string }>, tags: Array<{ __typename: 'Tag', id: string, name: string }>, tastemaker: { __typename: 'Tastemaker', id: string, isSetup: boolean, formattedPrice: string, user: { __typename: 'User', id: string, username: string, name: string, profile?: { __typename: 'UserProfile', id: string, avatar?: string | null } | null } }, orderedStops: Array<{ __typename: 'OrderedDateStop', id: string, order: number, formattedEstimatedTime: string, optional: boolean, options: Array<{ __typename: 'DateStopOption', id: string, optionOrder: number, title: string, content: string, hasNextOption: boolean, hasPreviousOption: boolean, nextOptionId?: string | null, previousOptionId?: string | null, showOptions: boolean, travel?: Array<{ __typename: 'Travel', distance: number, duration: number, mode: TravelMode, destinationId: string }> | null, location: { __typename: 'Location', id: string, name: string, website?: string | null, address: { __typename: 'Address', id: string, formattedAddress: string, city: { __typename: 'City', id: string, name: string }, coordinates: { __typename: 'Coordinates', lat: number, lng: number } } } }> }>, exploreMore: Array<{ __typename: 'FreeDate', id: string, title: string, archived: boolean, thumbnail: string, updatedAt: string, nsfw: boolean, description: string, viewerFavorited: boolean, estimatedTime: string, tastemaker: { __typename: 'Tastemaker', id: string, user: { __typename: 'User', id: string, name: string, profile?: { __typename: 'UserProfile', id: string, avatar?: string | null } | null } }, cities: Array<{ __typename: 'City', id: string, nameAndState: string }> }> };

export type DateStopItemFragment = { __typename: 'DateStop', id: string, title: string, order: number, optionOrder: number, content: string, estimatedTime: number, formattedEstimatedTime: string, travel?: Array<{ __typename: 'Travel', distance: number, duration: number, mode: TravelMode, destinationId: string }> | null, location: { __typename: 'Location', id: string, name: string, website?: string | null, address: { __typename: 'Address', id: string, formattedAddress: string, city: { __typename: 'City', id: string, name: string }, coordinates: { __typename: 'Coordinates', lat: number, lng: number } } } };

export type OrderedDateStopFragment = { __typename: 'OrderedDateStop', id: string, order: number, formattedEstimatedTime: string, optional: boolean, options: Array<{ __typename: 'DateStopOption', id: string, optionOrder: number, title: string, content: string, hasNextOption: boolean, hasPreviousOption: boolean, nextOptionId?: string | null, previousOptionId?: string | null, showOptions: boolean, travel?: Array<{ __typename: 'Travel', distance: number, duration: number, mode: TravelMode, destinationId: string }> | null, location: { __typename: 'Location', id: string, name: string, website?: string | null, address: { __typename: 'Address', id: string, formattedAddress: string, city: { __typename: 'City', id: string, name: string }, coordinates: { __typename: 'Coordinates', lat: number, lng: number } } } }> };

export type TravelItemFragment = { __typename: 'Travel', distance: number, duration: number, mode: TravelMode, destinationId: string };

export type DateStopOptionFragment = { __typename: 'DateStopOption', id: string, optionOrder: number, title: string, content: string, hasNextOption: boolean, hasPreviousOption: boolean, nextOptionId?: string | null, previousOptionId?: string | null, showOptions: boolean, travel?: Array<{ __typename: 'Travel', distance: number, duration: number, mode: TravelMode, destinationId: string }> | null, location: { __typename: 'Location', id: string, name: string, website?: string | null, address: { __typename: 'Address', id: string, formattedAddress: string, city: { __typename: 'City', id: string, name: string }, coordinates: { __typename: 'Coordinates', lat: number, lng: number } } } };
