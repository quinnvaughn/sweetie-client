...
export type RetireDateExperiencePayload = AuthError | DateExperience | Error;
...
export type UnretireDateExperiencePayload = AuthError | DateExperience | Error;
...
export type UpdateFreeDatePayload = AuthError | DateExperience | Error | FieldErrors;
...
export type DateStopItemFragment = { __typename: 'DateStop', id: string, title: string, order: number, content: string, location: { __typename: 'Location', id: string, name: string, website?: string | null, address: { __typename: 'Address', id: string, formattedAddress: string, coordinates: { __typename: 'Coordinates', lat: number, lng: number } } } };
...
export type CreateDateItineraryMutation = { __typename: 'Mutation', createDateItinerary: { __typename: 'AuthError', message: string } | { __typename: 'EntityCreationError', message: string } | { __typename: 'EntityNotFoundError', message: string } | { __typename: 'Error' } | { __typename: 'FieldErrors', fieldErrors: Array<{ __typename: 'FieldError', message: string, field: string }> } | { __typename: 'PlannedDate', plannedTime: string, experience: { __typename: 'DateExperience', title: string, tastemaker: { __typename: 'Tastemaker', user: { __typename: 'User', id: string, name: string, username: string } }, stops: Array<{ __typename: 'DateStop', location: { __typename: 'Location', name: string } }>, cities: Array<{ __typename: 'City', name: string }> } } };
...
export type SaveFreeDateDraftMutation = { __typename: 'Mutation', saveFreeDateDraft: { __typename: 'AuthError', message: string } | { __typename: 'DateExperienceDraft', id: string, title?: string | null, thumbnail?: string | null, updatedAt: string, author: { __typename: 'User', id: string, name: string, email: string } } | { __typename: 'Error', message: string } | { __typename: 'FieldErrors', fieldErrors: Array<{ __typename: 'FieldError', message: string, field: string }> } };
...
export type RetireFreeDateMutation = { __typename: 'Mutation', retireDateExperience: { __typename: 'AuthError', message: string } | { __typename: 'DateExperience', id: string, title: string, retired: boolean, thumbnail: string, updatedAt: string, nsfw: boolean, featured: boolean, description: string, featuredAt?: string | null, tastemaker: { __typename: 'Tastemaker', id: string, user: { __typename: 'User', id: string, name: string, profile?: { __typename: 'UserProfile', id: string, avatar?: string | null } | null } }, cities: Array<{ __typename: 'City', id: string, nameAndState: string }> } | { __typename: 'Error', message: string } };
...
export type UnretireFreeDateMutation = { __typename: 'Mutation', unretireDateExperience: { __typename: 'AuthError' } | { __typename: 'DateExperience', id: string, title: string, retired: boolean, thumbnail: string, updatedAt: string, nsfw: boolean, featured: boolean, description: string, featuredAt?: string | null, tastemaker: { __typename: 'Tastemaker', id: string, user: { __typename: 'User', id: string, name: string, profile?: { __typename: 'UserProfile', id: string, avatar?: string | null } | null } }, cities: Array<{ __typename: 'City', id: string, nameAndState: string }> } | { __typename: 'Error', message: string } };
...
export type GetDateExperienceQuery = { __typename: 'Query', dateExperience: { __typename: 'DateExperience', id: string, title: string, description: string, thumbnail: string, retired: boolean, nsfw: boolean, createdAt: string, updatedAt: string, isUserTastemaker: boolean, cities: Array<{ __typename: 'City', id: string, nameAndState: string, name: string }>, tags: Array<{ __typename: 'Tag', id: string, name: string }>, timesOfDay: Array<{ __typename: 'TimeOfDay', id: string, name: string }>, tastemaker: { __typename: 'Tastemaker', id: string, isSetup: boolean, formattedPrice: string, user: { __typename: 'User', id: string, username: string, name: string, profile?: { __typename: 'UserProfile', id: string, avatar?: string | null } | null } }, stops: Array<{ __typename: 'DateStop', id: string, title: string, order: number, content: string, location: { __typename: 'Location', id: string, name: string, website?: string | null, address: { __typename: 'Address', id: string, formattedAddress: string, coordinates: { __typename: 'Coordinates', lat: number, lng: number } } } }> } | { __typename: 'Error', message: string } };
...
export type GetFreeDateDraftQuery = { __typename: 'Query', freeDateDraft: { __typename: 'AuthError', message: string } | { __typename: 'DateExperienceDraft', id: string, title?: string | null, thumbnail?: string | null, description?: string | null, nsfw: boolean, tags: Array<{ __typename: 'Tag', id: string, name: string }>, timesOfDay: Array<{ __typename: 'TimeOfDay', id: string, name: string }>, stops: Array<{ __typename: 'DateStopDraft', id: string, order: number, title?: string | null, content?: string | null, location?: { __typename: 'Location', id: string, name: string } | null }> } | { __typename: 'Error', message: string } };
